            ...
            if (mysqli_num_rows($result_tugas) > 0) {
                while ($row_tugas = mysqli_fetch_assoc($result_tugas)) {
                    ...
                    $ext = match ($fileType) {
                        ...
                        "image/png" => "PNG",
                        "image/jpeg" => "JPG",
                        default => strtoupper(pathinfo($row_tugas["path"], PATHINFO_EXTENSION))
                    };

                    $sizeKB = $row_tugas["size"];
                        ...
                        ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-500 dark:text-white">
                                    <a href="tugas-submission-view.php" class="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:underline">
